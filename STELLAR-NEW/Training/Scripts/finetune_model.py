...
# Not useful for now since we have a custom callback
...
#### TEST TO SEE WTH IS WRONG WITH THE MODEL#######
# Define paths

#import time
#a = time.time()
#envstats_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "envstats")
#model_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Models")

parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
envstats_dir = os.path.join(parent_dir, "envstats")
model_dir = os.path.join(parent_dir, "Models")


#print('ENVSTATS DIR:', envstats_dir)
#print('MODEL DIR:', model_dir)
os.makedirs(envstats_dir, exist_ok=True)
envstats_path = os.path.join(envstats_dir, "vbar-agent_vecnormalize_225000_steps.pkl")
#print('ENVSTATS PATH:', envstats_path)
model_path = os.path.join(model_dir, "finetuned_model.zip")
logs_path = "./logs2/"
...
#print('MAKE VEC ENV')
env = make_vec_env(ARPOD_GYM, wrapper_class=TimeLimitWrapper, n_envs=20)

# Load or initialize VecNormalize
if os.path.exists(envstats_path):
    print('EXISTS')
    vec_env = VecNormalize.load(envstats_path, env)
    vec_env.training = False
    vec_env.norm_reward = False
    print("Loaded VecNormalize stats.")
else:
    print('NOT EXISTS')
    vec_env = VecNormalize(env, norm_obs=True, norm_reward=True, training=True)
    print("Initialized new VecNormalize.")
...
if os.path.exists(model_path):
    ...
    policy_dict = {
        'activation_fn': GELU,
        'net_arch': {'pi': [130, 44, 30], 'vf': [145, 25, 5]},
        'full_std': False,
        'squash_output': True,
        'log_std_init': 0,
        'use_expln': True
...
model.learn(total_timesteps=300_000, callback=callback,progress_bar=True)
#model.learn(total_timesteps=1_000_000, callback=callback)
#model.learn(total_timesteps=2_250_000, callback=callback)
...
#print(model_path)
vec_env.save(envstats_path)
#print(envstats_path)
#print('Time taken:', time.time() - a)
print('Model saved:', model_path)
print('VecNormalize stats saved:', envstats_path)
...
#stats_path = os.path.join('Training/envstats', 'vbar-agent_vecnormalize_2250000_steps.pkl')
#stats_path = os.path.join('Training/envstats', 'vbar-agent_vecnormalize_250000_steps.pkl')
#stats_path = os.path.join('Training/envstats', 'vbar-agent_vecnormalize_225000_steps.pkl')
#stats_path = os.path.join('Training/envstats', 'vbar-agent_vecnormalize_100000_steps.pkl')
#
stats_path = os.path.join('Training/envstats', 'vbar-agent_vecnormalize_200000_steps.pkl')
...
#modelname = 'vbar-agent_2250000_steps'
modelname = 'vbar-agent_200000_steps'

#modelname = 'vbar-500-800m.zip'
#model_dir = f'models/{modelname}'

model_dir = f'Training/envstats/{modelname}'
...
#loaded_model.save(model_path, "vbar-agent")
#loaded_model_path = os.path.join(model_dir, "vbar-agent")
#loaded_model.save(loaded_model_path)
model_dir = os.path.join(parent_dir, "Models")
loaded_model_path = os.path.join(model_dir, "vbar-agent.zip")
loaded_model.save(loaded_model_path)
