...
path = os.getcwd()
#path = '/Users/thomas/Desktop/MSc_IA/Lab_Project/ai_oos/STELLAR-COPY/runs'
print(path)
...
if only_x0 == 'Y':
    ...
    vis_obj = render_visual(data_dir = typegraph, only_inital = False, terminal_plots = False, run_file = None)
